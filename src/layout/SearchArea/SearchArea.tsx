  ...
  return (
    ...
    >
      ...
      <Box
        ...
        justifyContent={
          props.filterList !== undefined ? "space-between" : "end"
        }
        alignItems={"center"}
      >
        {/* 검색, 필터 */}
        ...
        <Box display={"flex"} alignItems={"center"}>
          {/* 커스텀 랜더링 */}
          {props.customControllerButton !== undefined && (
            <Box mr={1.5}>{props.customControllerButton}</Box>
          )}
