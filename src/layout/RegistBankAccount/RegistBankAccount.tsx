...
type Props = {
  ...
  setBankAccountInputStatus?: React.Dispatch<React.SetStateAction<IUserInputStatus>>;
...
const RegistBankAccount = (props: Props) => {
  ...
  const [bankAccountInputStatus, setBankAccountInputStatus] = useState<IUserInputStatus>({ status: 'default' });
        ...
        <Grid container spacing={1}>
          <Grid item xs={4}>
            <SelectTypeInput
              ...
              placeholder={'은행'}
              selectableList={bankName}></SelectTypeInput>
          </Grid>
