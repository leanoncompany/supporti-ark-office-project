...
const Footer = (props: IFooterProps) => {
  ...
  return (
    <Box borderTop={`1px solid ${themes.palette.grey[300]}`} mt={7} pt={7} pb={7} {...props.wrapperBoxProps}>
      <Container>
              ...
              <Box mb={2}>
                <Typography
                  ...
                  {Object.values(props.information).map((informationValue) => (
                    <span key={JSON.stringify(informationValue)} style={{ marginRight: '10px' }}>
                      <span
                        style={{
                          marginRight: '5px',
                        }}>
              ...
              <Box
                ...
                <Box>
                  ...
                  <Box>
                    ...
                    {props.contact.additionalInfoOfAvailableTime !== undefined && (
                      <Box>
                        <Typography
                          variant={'body2'}
                          sx={{
